...
//   const [docName, setDocName] = useState("");
  const { uploadFile, uploading, uploadUrl, uploadError } = useCloudinaryUpload();
...
const [documentType,setDocumentType] = useState("")
  ...
  const handleUpload = async () => {
    ...
    uploadDocumentMutation.mutate({
        ...
        dateOfBirth: "1990-01-01", // Replace with actual date of birth
        nationality:"Nigerian",
        blockchainHash: walletAddress as string, // Replace with actual hash
...
<div>
          ...
          >
            {uploading || uploadDocumentMutation.isPending ? "Uploading..." : "Upload Document"}
          </button>
          ...
          {uploadUrl || uploadDocumentMutation.data && (
